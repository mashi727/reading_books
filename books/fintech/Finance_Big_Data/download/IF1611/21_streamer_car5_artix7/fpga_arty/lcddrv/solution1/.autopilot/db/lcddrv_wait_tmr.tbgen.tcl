set moduleName lcddrv_wait_tmr
...
set isOneStateSeq 0
set C_modelName {lcddrv_wait_tmr}
...
set C_modelArgMapList {[ 
	{ "Name" : "tmr", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmr", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "tmr", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "lcddrv_wait_tmr", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1002", "Max" : "10000002"}
	, {"Name" : "Interval", "Min" : "1002", "Max" : "10000002"}
]}

set Spec2ImplPortList { 
	tmr { ap_none {  { tmr in_data 0 25 } } }
