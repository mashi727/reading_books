set moduleName bno055_uart_uart_write_reg
...
set isOneStateSeq 0
set C_modelName {bno055_uart_uart_write_reg}
set C_modelType { void 0 }
set C_modelArgList {
	{ reg_addr uint 7 regular  }
	{ data int 8 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "reg_addr", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ reg_addr sc_in sc_lv 7 signal 0 } 
	{ data sc_in sc_lv 8 signal 1 } 
	{ uart_tx sc_out sc_lv 1 signal 2 } 
	{ uart_tx_ap_vld sc_out sc_logic 1 outvld 2 } 
	...
	{ uart_rx sc_in sc_lv 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "reg_addr", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "reg_addr", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "6"], "CDFG" : "bno055_uart_uart_write_reg", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bno055_uart_uart_receive_byte_fu_44", "Parent" : "0", "Child" : ["2", "3"], "CDFG" : "bno055_uart_uart_receive_byte", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "uart_rx", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : [
		...
		"SubBlockPort" : []},
	{"Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bno055_uart_uart_receive_byte_fu_44.grp_bno055_uart_wait_tmr_fu_85", "Parent" : "1", "Child" : [], "CDFG" : "bno055_uart_wait_tmr", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "tmr", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "dummy_tmr_out", "Type" : "OVld", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bno055_uart_uart_receive_byte_fu_44.grp_bno055_uart_read_uart_rx_fu_95", "Parent" : "1", "Child" : [], "CDFG" : "bno055_uart_read_uart_rx", "VariableLatency" : "0", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "1", "ControlExist" : "0",
		"Port" : [
		{"Name" : "uart_rx", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bno055_uart_uart_send_byte_fu_52", "Parent" : "0", "Child" : ["5"], "CDFG" : "bno055_uart_uart_send_byte", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "data", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "uart_tx", "Type" : "Vld", "Direction" : "O", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "dummy_tmr_out", "Type" : "OVld", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : [
		...
		"SubBlockPort" : []},
	{"Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bno055_uart_uart_send_byte_fu_52.grp_bno055_uart_wait_tmr_fu_71", "Parent" : "4", "Child" : [], "CDFG" : "bno055_uart_wait_tmr", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "tmr", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "dummy_tmr_out", "Type" : "OVld", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bno055_uart_wait_tmr_fu_64", "Parent" : "0", "Child" : [], "CDFG" : "bno055_uart_wait_tmr", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "tmr", "Type" : "None", "Direction" : "I", "BlockSignal" : [], "SubConnect" : []}, 
		{"Name" : "dummy_tmr_out", "Type" : "OVld", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}],
		"WaitState" : [],
...
set Spec2ImplPortList { 
	reg_addr { ap_none {  { reg_addr in_data 0 7 } } }
