...
#ifndef _bno055_uart_bin2char_HH_
#define _bno055_uart_bin2char_HH_
...
struct bno055_uart_bin2char : public sc_module {
    // Port declarations 2
    sc_in< sc_lv<4> > val_r;
    ...
    // Module declarations
    bno055_uart_bin2char(sc_module_name name);
    SC_HAS_PROCESS(bno055_uart_bin2char);

    ~bno055_uart_bin2char();
