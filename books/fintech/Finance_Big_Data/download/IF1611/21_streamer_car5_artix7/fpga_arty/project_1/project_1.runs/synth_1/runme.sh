...
HD_PWD='D:/21_streamer_car5_artix7/fpga_arty/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log car_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source car_top.tcl
