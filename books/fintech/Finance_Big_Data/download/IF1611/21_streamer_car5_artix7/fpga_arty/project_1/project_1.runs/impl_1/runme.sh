...
HD_PWD='D:/21_streamer_car5_artix7/fpga_arty/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log car_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source car_top.tcl -notrace
