...
for (user in usernames) {
  ...
  # データ期間を絞り込み、データを抽出
  grep_text1 <- grep("2016-09-18", df_tw$created)
  grep_text2 <- grep("2016-09-19", df_tw$created)
  grep_text3 <- grep("2016-09-20", df_tw$created)
  grep_text4 <- grep("2016-09-21", df_tw$created)
  grep_text5 <- grep("2016-09-22", df_tw$created)
  grep_text6 <- grep("2016-09-23", df_tw$created)
  grep_text7 <- grep("2016-09-24", df_tw$created)
