...
for (user in usernames) {
  ...
  # データ期間を絞り込み、データを抽出
  grep_text1 <- grep("2016-04", df_tw$created)
  grep_text2 <- grep("2016-05", df_tw$created)
  grep_text3 <- grep("2016-06", df_tw$created)
  grep_text4 <- grep("2016-07", df_tw$created)
  grep_text5 <- grep("2016-08", df_tw$created)
  grep_text6 <- grep("2016-09", df_tw$created)
  ...
  # サンプリング
  df_tw <- sample_n(tbl = df_tw, size = 150)
