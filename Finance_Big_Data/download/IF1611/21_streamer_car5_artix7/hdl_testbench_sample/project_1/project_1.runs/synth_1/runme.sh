...
HD_PWD='D:/hdl_testbench_sample/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sample_circuit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sample_circuit.tcl
