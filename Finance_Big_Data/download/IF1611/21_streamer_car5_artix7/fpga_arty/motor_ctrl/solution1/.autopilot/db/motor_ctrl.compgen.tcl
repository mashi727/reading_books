...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_l_dir \
    op interface \
    ports { l_dir_i { I 1 vector } l_dir_o { O 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_l_pwm \
    op interface \
    ports { l_pwm_i { I 1 vector } l_pwm_o { O 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_r_dir \
    op interface \
    ports { r_dir_i { I 1 vector } r_dir_o { O 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_r_pwm \
    op interface \
    ports { r_pwm_i { I 1 vector } r_pwm_o { O 1 vector } } \
} "
}
